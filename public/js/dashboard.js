...
const Dashboard = {
            ...
            return `
                        <div style="display: flex; align-items: center; gap: 8px;">
                            ...
                            <div style="flex: 1; background: #e8e8e8; border-radius: 2px; height: 18px; overflow: hidden;">
                                <div style="background: linear-gradient(90deg, #059669, #4a9fd4); width: ${width}%; height: 100%; display: flex; align-items: center; justify-content: flex-end; padding-right: 6px;">
    ...
    renderModernRanking(topStores) {
        ...
        const colors = [
            ...
            'linear-gradient(135deg, #10b981, #60a5fa)'
        ];
