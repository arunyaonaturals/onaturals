            ...
            contentArea.innerHTML = `
                ...
                <div style="background: #f5f5f5; min-height: 100%; padding: 0;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 0; border-bottom: 1px solid #ddd;">
                        ${this.renderKPI('Total Orders', (this.summary.total || 0).toString(), 'All invoices', '#059669', '📋')}
                        ...
                        <div>
                            ...
                            <div style="background: white;">
                                ...
                                <div style="padding: 12px 16px;">
                                    <button id="initAllDeliveries" style="width: 100%; background: #059669; color: white; border: none; padding: 10px; border-radius: 4px; margin-bottom: 8px; cursor: pointer; font-size: 12px;">
        ...
        return `
            ...
            return `
                            <tr style="background: ${idx % 2 === 0 ? '#fff' : '#f8f9fa'};" class="order-row">
                                <td style="padding: 8px 12px; font-weight: 500; color: #059669;">${order.invoiceNo}</td>
            ...
            const content = `
                <div style="margin-bottom: 16px; padding: 12px; background: #f8f9fa; border-radius: 4px;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <div style="font-weight: 600; color: #059669;">${order.invoiceNo}</div>
