            ...
            contentArea.innerHTML = `
                ...
                <div style="background: #f5f5f5; min-height: 100%; padding: 0;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 0; border-bottom: 1px solid #ddd;">
                        ${this.renderKPI('Total Products', this.products.length.toString(), 'In catalog', '#059669', '📦')}
        ...
        return `
            ...
            return `
                            <tr style="background: ${idx % 2 === 0 ? '#fff' : '#f8f9fa'};" class="stock-row">
                                ...
                                <td style="padding: 8px 12px; text-align: right; color: #059669;">${item.batchCount}</td>
        ...
        return `
            <form id="productionForm">
                ...
                <div style="margin-bottom: 16px; display: grid; grid-template-columns: 2fr 1fr auto; gap: 8px; align-items: end;">
                    ...
                    <button type="button" id="addMaterialBtn" style="background: #059669; color: white; border: none; padding: 6px 10px; border-radius: 4px; font-size: 11px; cursor: pointer;">+ Add</button>
                </div>
